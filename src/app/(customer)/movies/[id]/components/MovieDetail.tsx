        ...
        <div className="absolute bottom-0 left-0 right-0 z-20 p-8 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1">
              ...
              <h2 className="text-xl md:text-2xl text-yellow-400 mb-4 font-medium">
                {movie.titleVi}
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-300">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2 mt-1">
                      {(movie.director ? movie.director.split(",") : []).map(
                        (d, idx) => {
                          const name = d.trim();
                          return name ? (
                            <span
                              key={idx}
                              className="bg-[#23232b] text-white px-4 py-1 rounded-lg text-sm font-medium"
                            >
                              {name}
                            </span>
                          ) : null;
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2 mt-1">
                      {(movie.actor ? movie.actor.split(",") : []).map(
                        (a, idx) => {
                          const name = a.trim();
                          return name ? (
                            <span

        ...
        <nav className="hidden lg:flex space-x-8">
          ...
          <div className="group relative">
            ...
            <div className="absolute left-0 mt-2 w-48 bg-black/90 rounded-md shadow-lg overflow-hidden z-20 transform scale-0 group-hover:scale-100 transition-transform origin-top duration-200">
              <Link href="/movies/now-showing" className="block px-4 py-3 text-white hover:bg-red-600 transition">Phim đang chiếu</Link>
              <Link href="/movies/coming-soon" className="block px-4 py-3 text-white hover:bg-red-600 transition">Phim sắp chiếu</Link>
              <Link href="/movies/top-rated" className="block px-4 py-3 text-white hover:bg-red-600 transition">Phim đánh giá cao</Link>
            </div>
          </div>
          <div className="group relative">
            <Link href="/theaters" className="text-white hover:text-red-500 transition font-medium flex items-center">
              Rạp
              <svg className="ml-1 w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
              </svg>
            ...
            <div className="absolute left-0 mt-2 w-48 bg-black/90 rounded-md shadow-lg overflow-hidden z-20 transform scale-0 group-hover:scale-100 transition-transform origin-top duration-200">
              <Link href="/theaters/cgv" className="block px-4 py-3 text-white hover:bg-red-600 transition">CGV</Link>
              <Link href="/theaters/lotte" className="block px-4 py-3 text-white hover:bg-red-600 transition">Lotte Cinema</Link>
              <Link href="/theaters/galaxy" className="block px-4 py-3 text-white hover:bg-red-600 transition">Galaxy Cinema</Link>
            </div>
          </div>
          ...
          <nav className="flex flex-col space-y-4">
            ...
            <div>
              ...
              <div className="pl-4 mt-2 space-y-2">
                <Link href="/movies/now-showing" className="text-gray-300 hover:text-red-500 transition py-1 block">Phim đang chiếu</Link>
                <Link href="/movies/coming-soon" className="text-gray-300 hover:text-red-500 transition py-1 block">Phim sắp chiếu</Link>
                <Link href="/movies/top-rated" className="text-gray-300 hover:text-red-500 transition py-1 block">Phim đánh giá cao</Link>
              </div>
            </div>
            <div>
              <Link href="/theaters" className="text-white hover:text-red-500 transition py-2 border-b border-gray-700 block">Rạp</Link>
              <div className="pl-4 mt-2 space-y-2">
                <Link href="/theaters/cgv" className="text-gray-300 hover:text-red-500 transition py-1 block">CGV</Link>
                <Link href="/theaters/lotte" className="text-gray-300 hover:text-red-500 transition py-1 block">Lotte Cinema</Link>
                <Link href="/theaters/galaxy" className="text-gray-300 hover:text-red-500 transition py-1 block">Galaxy Cinema</Link>
              </div>
            </div>

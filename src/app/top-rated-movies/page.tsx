...
export default function EarlyScreeningMovies() {
  ...
  return (
    <>
      <Head>
        <title>Phim chiếu sớm | Moviesite</title>
        <meta name="description" content="Danh sách phim chiếu sớm" />
      ...
      <main>
        ...
        <div className="relative w-full h-64 md:h-80">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-white z-20 px-4">
            <h1 className="text-3xl md:text-4xl font-bold mb-2">Phim được đánh giá cao</h1>
            <p className="text-sm md:text-base text-center max-w-3xl">
              Danh sách các phim nhận được đánh giá cao từ khán giả và giới phê bình.
            </p>
          </div>
        </div>
